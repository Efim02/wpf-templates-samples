namespace Nst.UI.AttachedProperties;
...
public class GridAp : UIElement
{
    ...
    /// <summary>
    /// Получает длины колонок.
    /// </summary>
    public static GridLengths GetColumnLengths(Grid element) => (GridLengths)element.GetValue(ColumnLengthsProperty);

    /// <summary>
    /// Получает длины строк.
    /// </summary>
    public static GridLengths GetRowLengths(Grid element) => (GridLengths)element.GetValue(RowLengthsProperty);

    /// <summary>
    /// Устанавливает длины колонок.
    /// </summary>
